...
int main()
{
    ...
    cout << "\t\t\t\t\t\t\tis" << endl;
    cout << "task3" << endl;
    cout << "\t\t THE GARAGE FOR SALE" << endl;
    cout << "\t\t   5 square meters" << endl;
    cout << "\t\t   Lyashenko Roman" << endl;
    cout << "\t\tPhone:8 (800)-555-35-35" << endl;
    cout << "\t  \t  8 \t  8\t  8" << endl;
    cout << "\t\t(800)\t(800)\t(800)" << endl;
    cout << "\t\t 555\t 555\t 555" << endl;
    cout << "\t  \t 35 \t 35\t 35" << endl;
    cout << "\t  \t 35 \t 35\t 35" << endl;
}
